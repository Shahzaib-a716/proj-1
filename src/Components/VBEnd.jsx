...
const CustomLayout = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center p-5">
      ...
      <div className="text-center mb-5">
        ...
        <h1 className="text-white text-4xl font-bold">Trades Persons Perfect Business System</h1>
      </div>

      {/* Main Content Area */}
      <div className="relative bg-gray-500 p-4 border-4 border-gray-300">
        {/* Left Side Icons */}
        <div className="absolute left-[-80px] top-[80px] space-y-6">
          <img src="/path/to/icon1.png" alt="Icon 1" className="w-16 h-16" />
          <img src="/path/to/icon2.png" alt="Icon 2" className="w-16 h-16" />
          <img src="/path/to/icon3.png" alt="Icon 3" className="w-16 h-16" />
        </div>

        {/* Right Side Icons */}
        <div className="absolute right-[-65px] top-[20px]">
  ...
  />
      ...
      <div className="grid grid-cols-6 mt-2">
        ...
        <img src="/assets/images/button bottom setup.webp" alt="Icon 9" className="w-18 h-16" />
